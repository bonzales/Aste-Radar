...
## 5. La sveglia: cron giornaliero alle 07:00
...
```cron
0 7 * * * cd /home/<utente>/aste-radar && /home/<utente>/aste-radar/.venv/bin/python -m src.main >> /home/<utente>/aste-radar/logs/aste.log 2>&1
```
Da qui in poi aste-radar lavora da solo: ogni mattina controlla i nuovi lotti e
